...
d3.json("https://github.com/sofiajuarez/DataProcessing/blob/master/Homework/week_7/data/hw6exports.json", function(error, jsondata){

	//Error checking
	if (error) throw error;

	//Define variables.
	/* 	Note: I had to manually define the width since var width = d3.max(jsondata, function(d){ return d[2006];}); gave a wrong number, unlike
